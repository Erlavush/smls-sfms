...
import { PaperClipIcon, DocumentTextIcon, CalendarDaysIcon, BuildingLibraryIcon, PresentationChartBarIcon, MapPinIcon, EyeIcon } from '@heroicons/react/24/outline'; // Added EyeIcon
            ...
            <div className="flex flex-wrap items-center justify-between gap-y-2 gap-x-4 pt-3 border-t border-gray-100 mt-2">
                ...
                {isEditing && stagedFile ? (
                    ...
                    >
                       ...
                       <span>Preview Proof/Details</span>
                    </button>
                ) : (
